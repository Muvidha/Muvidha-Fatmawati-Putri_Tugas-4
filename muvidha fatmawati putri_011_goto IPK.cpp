...
int main()
{
  ...
  char mk[30], nilaihuruf[50][30], matkul[50][50][30], ulang;
  ...
  if (jmlsmt < 1 || jmlsmt > 14) {
    ...
    for (i = 0; i < jmlsmt; i++) {
      ...
      cin >> jmlmk;
      if (jmlmk < 1) {
        cout << "Jumlah matakuliah kurang dari 1 setiap semester\n";
        return 0;
      }
      else {
  ...
  cout <<"==============================================\n";
	...
	cout << "Apakah Anda Ingin Menghitung IPK lagi [y/n]? "; cin >> ulang;
	if (ulang == 'y' || ulang == 'Y'){
		system ("cls");
		goto menu;
	}
	else if (ulang == 'n' || ulang == 'N'){
		cout << "Sampai Jumpa Lagii" << endl;
	}
  return 0;
}
